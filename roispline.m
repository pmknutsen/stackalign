...
%             DEFAULT = 0 (optional)
% - points  : Input [x y] points (optional)
%
% OUTPUT :
% - mask    : Binary mask of segmented ROI
%   i       : i coordinates of points
%   j       : j coordinates of points
%
% Notes:
    ...
    case 'natural'
        while flag
            ...
            switch bottone
                ...
                case 2
                    % Abort and finish if middle button is pressed
                    if i == 2
                        mask = [];
                        i = [];
                        j = [];
            ...
            if i>1
                ...
                set(hLine, 'xdata', points(1,:), 'ydata', points(2,:))
                set(hDots, 'xdata', cor(1,:), 'ydata', cor(2,:))
            end
        end
    case 'cardinal'
        while flag
            ...
            if i>1
                ...
                set(hLine, 'xdata', pointsx, 'ydata', pointsy)
                set(hDots, 'xdata', x, 'ydata', y)
            end
        end
    ...
    otherwise
        ...
        if iscell(breaks)
            ...
            if exist('basicint','var')
                ...
                if jumps, extrap = repmat(NaN,d,1);
                else extrap = zeros(d,1); end
